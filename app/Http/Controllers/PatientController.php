...
class PatientController extends Controller{   
    ...
    public function patient_dashboard(Request $request){
      ...
      $id      = $session->id;
      $appointment =    DB::select("select *,admin.id as id from admin left join profile_details on profile_details.admin_id=admin.id join appointment_booked on doctor_id=admin.id  where patient_id='$id'");
