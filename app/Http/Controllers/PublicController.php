    ...
    public function doctor_profile_setting_submit(Request $request){
        ...
        if ($validator->fails()){
            ...
            $update = array(
                  ...
                  'about_us'=> !empty($request->input('about_us'))?$request->input('about_us'):"",
            ...
            $insert_update = array(
                  'clinic_name' => !empty($request->input('clinic_name'))?$request->input('clinic_name'):"",
                  ...
                  'clinic_specialist'=> !empty($request->input('clinic_specialist'))?$request->input('clinic_specialist'):"",
                  ...
                  'clinic_fee_validity'=> !empty($request->input('clinic_fee_validity'))?$request->input('clinic_fee_validity'):"",
