								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										<div class="login-header">
											<h3>Patient Register <a href="<?php echo e(url('doctor_registration')); ?>">Are you a Doctor?</a></h3>
										</div>
										
										<!-- Register Form -->
										 <form id="needs-validation" novalidate class="needs-validation"  role="form" enctype="multipart/form-data" method="post" action="<?php echo e(url('patient_registration_submit')); ?>">
