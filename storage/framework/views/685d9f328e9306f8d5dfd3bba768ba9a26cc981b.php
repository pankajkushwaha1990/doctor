...
<head>
		...
		<!-- Daterangepikcer CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('template')); ?>/assets/plugins/daterangepicker/daterangepicker.css">
	...
	<body>
								...
								<div class="card-body">
									<div class="booking-doc-info">
										<a href="doctor-profile.html" class="booking-doc-img">
											<img src="<?php echo e(asset('doctor_files')); ?>/<?php echo e($doctor->profile_picture); ?>" alt="User Image">
										</a>
										<div class="booking-info">
											<h4><a href="doctor-profile.html"><?php echo e($doctor->name); ?></a></h4>
											<!-- <div class="rating">
											...
											<p class="text-muted mb-0"><i class="fas fa-map-marker-alt"></i> <?php echo e(ucfirst($doctor->clinic_address)); ?>, <?php echo e(ucfirst($doctor->clinic_city)); ?>,<?php echo e(ucfirst($doctor->clinic_country)); ?></p>
										</div>
									</div>
								</div>
							</div>
							<input type="hidden" class="doctor_id" value="<?php echo e(base64_encode(base64_encode($doctor->id))); ?>">
							<div class="row">
										...
										<div class="col-md-12">
											...
											<div class="day-slot">
												...
												foreach ($days as $key => $add_day) {
													...
													// $date = date('Y-m-d');
												?>
												<a href="<?php echo e(url('doctor_appointment_booking')); ?>/<?php echo e(base64_encode(base64_encode($doctor->id))); ?>?appointment_date=<?php echo e($date); ?>">
												...
												foreach ($start as $key => $value) { ?>
													<li style="padding-top: 5px;padding-bottom: 5px;width:19.28%">
														<a class="timing <?php $booking= $start[$key]." - ".$end[$key]; if($booking_slot==$booking){ echo 'selected'; } ?>"  href="javascript:void(0)">
															<span><?php echo e($start[$key]); ?> - <?php echo e($end[$key]); ?></span>
														</a>
													</li>
		...
		<script src="<?php echo e(asset('template')); ?>/assets/plugins/daterangepicker/daterangepicker.js"></script>
		
		<!-- Custom JS -->
		<script src="<?php echo e(asset('template')); ?>/assets/js/script.js"></script>
		<script src="<?php echo e(asset('template')); ?>/assets/js/sweetalert.min.js"></script>
	...
	<div class="modal-dialog modal-login">
		<div class="modal-content">
			<form id="ajax_login_form" method="post" action="<?php echo e(url('admin_login_submit')); ?>">
