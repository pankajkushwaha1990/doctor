							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										<h4 class="doc-name"><?php echo e($doctor->name); ?></h4>
										<p class="doc-speciality"><?php echo e($doctor->designation); ?></p>
										<!-- <p class="doc-department"><img src="<?php echo e(asset('template')); ?>/assets/img/specialities/specialities-05.png" class="img-fluid" alt="Speciality">Dentist</p> -->
										<!-- <div class="rating">
											...
											<!-- <ul class="clinic-gallery">
												...
												<li>
													<a href="<?php echo e(asset('template')); ?>/assets/img/features/feature-02.jpg" data-fancybox="gallery">
														<img  src="<?php echo e(asset('template')); ?>/assets/img/features/feature-02.jpg" alt="Feature Image">
													</a>
												</li>
												<li>
										...
										<div class="col-md-12 col-lg-9">
													...
													<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name"><?php echo e($institute[$key]); ?></a>
																	<div><?php echo e($degree[$key]); ?></div>
																	<span class="time"><?php echo e($completion_year[$key]); ?></span>
																</div>
															</div>
														</li>
												...
												<div class="experience-box">
													...
													foreach($hospital_name as $key=>$value){ ?>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name"><?php echo e($hospital_name[$key]); ?></a>
																	<span class="time"><?php echo e($experience_from[$key]); ?> - <?php echo e($experience_to[$key]); ?></span>
																</div>
															</div>
														</li>
												...
												<div class="experience-box">
													...
													foreach($award_name as $key=>$value){ ?>	
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<p class="exp-year"><?php echo e($award_year[$key]); ?></p>
																	<h4 class="exp-title"><?php echo e($award_name[$key]); ?></h4>
											...
											<div class="service-list">
												...
												<ul class="clearfix">
												   ...
												   $services = explode(',',$doctor->clinic_services);
												   foreach($services as $service){ ?>
												     <li><?php echo e(ucfirst($service)); ?></li>
												   <?php } ?>
												</ul>
											</div>
											<!-- /Services List -->
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="clinic-content">
													<h4 class="clinic-name"><a href="#"><?php echo e($doctor->clinic_name); ?></a></h4>
													...
													<div class="clinic-details mb-0">
														<h5 class="clinic-direction"> <i class="fas fa-map-marker-alt"></i> <?php echo e(ucfirst($doctor->clinic_address)); ?>, <?php echo e(ucfirst($doctor->clinic_city)); ?>,<?php echo e(ucfirst($doctor->clinic_country)); ?> <br>
															<!-- <a href="javascript:void(0);">Get Directions</a></h5> -->
														<!-- <ul>
															<li>
																<a href="<?php echo e(asset('template')); ?>/assets/img/features/feature-01.jpg" data-fancybox="gallery2">
																	<img src="<?php echo e(asset('template')); ?>/assets/img/features/feature-01.jpg" alt="Feature Image">
																</a>
															</li>
															<li>
																<a href="<?php echo e(asset('template')); ?>/assets/img/features/feature-02.jpg" data-fancybox="gallery2">
																	<img src="<?php echo e(asset('template')); ?>/assets/img/features/feature-02.jpg" alt="Feature Image">
																</a>
															</li>
															<li>
																<a href="<?php echo e(asset('template')); ?>/assets/img/features/feature-03.jpg" data-fancybox="gallery2">
																	<img src="<?php echo e(asset('template')); ?>/assets/img/features/feature-03.jpg" alt="Feature Image">
																</a>
															</li>
															<li>
																<a href="<?php echo e(asset('template')); ?>/assets/img/features/feature-04.jpg" data-fancybox="gallery2">
																	<img src="<?php echo e(asset('template')); ?>/assets/img/features/feature-04.jpg" alt="Feature Image">
																</a>
															</li>
														</ul> -->
													</div>
												...
												<div class="clinic-timing">
													<div>
														...
														<p class="timings-times">
															<span><?php echo e(ucfirst($doctor->clinic_open_time)); ?> - <?php echo e(ucfirst($doctor->clinic_close_time)); ?></span>
								...
								<div role="tabpanel" id="doc_reviews" class="tab-pane fade">
									...
									<div class="widget review-listing">
										<ul class="comments-list">
											...
											<li>
												<div class="comment">
													<img class="avatar avatar-sm rounded-circle" alt="User Image" src="<?php echo e(asset('template')); ?>/assets/img/patients/patient.jpg">
												...
												<ul class="comments-reply">
													<li>
														<div class="comment">
															<img class="avatar avatar-sm rounded-circle" alt="User Image" src="<?php echo e(asset('template')); ?>/assets/img/patients/patient1.jpg">
															<div class="comment-body">
																<div class="meta-data">
											...
											<li>
												<div class="comment">
													<img class="avatar avatar-sm rounded-circle" alt="User Image" src="<?php echo e(asset('template')); ?>/assets/img/patients/patient2.jpg">
													<div class="comment-body">
														<div class="meta-data">
						...
						<div class="call-box incoming-box">
							<div class="call-wrapper">
								<div class="call-inner">
									<div class="call-user">
										<img alt="User Image" src="<?php echo e(asset('template')); ?>/assets/img/doctors/doctor-thumb-02.jpg" class="call-avatar">
					...
					<div class="modal-body">
						...
						<div class="call-box incoming-box">
							<div class="call-wrapper">
								<div class="call-inner">
									<div class="call-user">
										<img class="call-avatar" src="<?php echo e(asset('template')); ?>/assets/img/doctors/doctor-thumb-02.jpg" alt="User Image">
										<h4>Dr. Darren Elder</h4>
										<span>Calling ...</span>
									</div>							
									<div class="call-items">
