						...
						<div class="col-md-7 col-lg-8">
							<div class="card">
								<div class="card-body">
									...
									<!-- Checkout Form -->
						<form  enctype="multipart/form-data" class="needs-validation" method="post" action="<?php echo e(url('patient_appointment_checkout_submit')); ?>">
          				 <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
										...
										<div class="info-widget">
											...
											<div class="row">
													...
													<div class="col-md-12 col-sm-12">
														...
														$family_name     = json_decode($patient[0]->family_name,true);
													 	...
													 	foreach ($family_name as $key => $value) { ?>
													 		     	<option value="<?php echo e($family_name[$key]); ?>||<?php echo e($family_relation[$key]); ?>||<?php echo e($family_dob[$key]); ?>"><?php echo e($family_name[$key]); ?>  (<?php echo e($family_relation[$key]); ?>) <?php echo e($family_dob[$key]); ?></option>
													 	<?php } ?>
													 		      </select>
													 			</div>
															</div>
												...
												<?php }
												?>
													<input type="hidden" required="" name="ref_url" value=" <?php echo e($ref_url); ?>">
													<input type="hidden" required="" name="doctor_fee" value=" <?php echo e($doctor->clinic_fee); ?>">
								...
								<div class="card-body">
									...
									<div class="booking-doc-info">
										<a href="doctor-profile.html" class="booking-doc-img">
											<img src="<?php echo e(asset('template')); ?>/assets/img/doctors/doctor-thumb-02.jpg" alt="User Image">
										</a>
										<div class="booking-info">
											...
											<div class="clinic-details">
												<p class="doc-location"><i class="fas fa-map-marker-alt"></i> <?php echo e(ucfirst($doctor->clinic_address)); ?> <br> <?php echo e(ucfirst($doctor->clinic_city)); ?>,<?php echo e(ucfirst($doctor->clinic_country)); ?></p>
											</div>
										</div>
									</div>
									<!-- Booking Doctor Info -->
										...
										<div class="booking-item-wrap">
											...
											<div class="booking-total">
												<ul class="booking-total-list">
													<li>
														<span>Total</span>
														<span class="total-cost"><?php echo e($fee); ?></span>
													</li>
												</ul>
											</div>
										</div>
