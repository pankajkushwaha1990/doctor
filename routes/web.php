...
Route::post('/doctor_appointments_review_submit', 'PatientController@doctor_appointments_review_submit');
...
Route::get('/patient_member', 'PatientController@patient_member');
