        ...
        <div class="card-header">
              <div class="row">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('set-new-password-submit') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="password2" type="hidden" class="form-control" name="email_key" value="{{ $email }}" required>
