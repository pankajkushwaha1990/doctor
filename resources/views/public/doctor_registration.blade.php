								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										<div class="login-header">
											<h3>Doctor Register <a href="{{ url('patient_registration') }}">Not a Doctor?</a></h3>
										</div>
										<div class="login-header">
											 <h6 class="card-title">
										...
										<!-- Register Form -->
										 <form id="needs-validation" novalidate class="needs-validation" role="form" enctype="multipart/form-data" method="post" action="{{ url('doctor_registration_submit') }}" oninput='confirm_password.setCustomValidity(confirm_password.value != password.value ? "Passwords do not match." : "")'>
