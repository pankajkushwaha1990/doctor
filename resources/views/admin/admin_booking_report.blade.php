      ...
      <!-- Page Wrapper -->
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
						<div class="col-md-12">
			<form role="form" enctype="multipart/form-data" method="get" action="{{ url('admin_booking_report') }}">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<?php 
					                        $doctor_id = $appointment_type = $from = $to = '';
					                        $package_id_get = 'all';
										...
										<div class="col-md-3">
											<div class="form-group">
												<select class="form-control" name="doctor_id" >
													...
													<option {{ $doctor_id==$patient->doctor_id ? "selected" : "" }} value="{{ $patient->doctor_id }}">{{ $patient->name }} {{ $patient->mobile }}</option>
													@endforeach
													@endif
									              ...
									              <div class="card">
									                <div class="card-body">
									                  <div class="dash-widget-header">
									                    ...
									                    <div class="dash-count">
									                      <h3>{{ $total_new_appointment }}</h3>
									                    </div>
									                  </div>
									                  <div class="dash-widget-info">
									                    
									                    <h6 class="text-muted">New Appoinments</h6>
									                    <div class="progress progress-sm">
									              ...
									              <div class="card">
									                <div class="card-body">
									                  <div class="dash-widget-header">
									                    ...
									                    <div class="dash-count">
									                      <h3>{{ $total_old_appointment }}</h3>
									                    </div>
									                  </div>
									                  <div class="dash-widget-info">
									                    
									                    <h6 class="text-muted">Old Appoinments</h6>
									                    <div class="progress progress-sm">
									                      <div class="progress-bar bg-danger w-50"></div>
									                    </div>
									                  </div>
